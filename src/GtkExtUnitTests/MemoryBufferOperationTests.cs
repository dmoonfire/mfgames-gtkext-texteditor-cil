...
namespace MfGames.GtkExt.TextEditor.Models.Tests
{
	...
	public class MemoryBufferOperationTests
	{
		...
		public void DeleteTextFromMiddleOfLine()
		{
			...
			Assert.AreEqual(0,results.TextPosition.LinePosition.Index);
			Assert.AreEqual(4,results.TextPosition.CharacterPosition.Index);
		}
		...
		public void InsertTextIntoBeginningOfLine()
		{
			...
			LineBufferOperationResults results =
				buffer.InsertText(new TextPosition(0, 0), input);
		...
		public void InsertTextIntoEndOfLine()
		{
			...
			// Operation
			LineBufferOperationResults results =
				buffer.InsertText(new TextPosition(0, "Original".Length), input);
			...
			Assert.AreEqual(0,results.TextPosition.LinePosition.Index);
			Assert.AreEqual(
				"Original Test".Length,results.TextPosition.CharacterPosition.Index);
		}
		...
		public void InsertTextIntoMaxEndOfLine()
		{
			...
			// Operation
			LineBufferOperationResults results =
				buffer.InsertText(new TextPosition(0, Int32.MaxValue), input);
		...
		public void InsertTextIntoMiddleOfLine()
		{
			...
			// Operation
			LineBufferOperationResults results =
				buffer.InsertText(new TextPosition(0, 4), input);
			...
			Assert.AreEqual(0,results.TextPosition.LinePosition.Index);
			Assert.AreEqual(4 + input.Length,results.TextPosition.CharacterPosition.Index);
		}
